               ...
               <div>
                ...
                <div className="followDiv container-fluid">
                    <div className="row">
                       ...
                       <Link to={`/${this.state.user !==undefined ? this.state.user.id:null}/follows`}><div className="followNumber col-md-4">{this.state.user !==undefined ? this.state.user.followCount:null} <span className="followText">Takip Edilen</span></div></Link> 
                ...
                <div className="container-fluid">
                    <Tweet Tweets={this.props.tweets} Retweet={this.props.Retweet} deleteTweet={this.props.deleteTweet}  />
                </div>
                </div>
            </div>
            </React.Fragment>
